...
#define STRING_CONFIG_H_AUTHOR "(Dima Rozhkov)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10 Mini 30 Jan 2021"
...
//#define RGBW_LED
  ...
  #define RGB_LED_R_PIN P0_15
  #define RGB_LED_G_PIN P0_16
  #define RGB_LED_B_PIN P0_17
